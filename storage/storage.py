...
def record_swipe():
    ...
    outfit_category = data.get('category')
    ...
    if user_id and action and outfit_id:
        ...
        user_swipe_counts[user_id][action] += 1
        user_swipe_counts[user_id]['last_category'] = outfit_category
        ...
        if action == 'left' and user_swipe_counts[user_id]['left'] >= 5:
            ...
            return jsonify({"message": "Swipe recorded successfully", "most_rated_outfit": most_rated_outfit}), 200
